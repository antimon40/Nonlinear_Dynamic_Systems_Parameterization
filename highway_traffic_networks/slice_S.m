function [S_L,S_R] = slice_S(S,q,param,type,fun_mode,sys)
...
Y = traffic_fun_inval_wrapper(S_L.h,param,type,q,fun_mode,sys);
...
Y = traffic_fun_inval_wrapper(S_R.h,param,type,q,fun_mode,sys);
%Compute its lower bound
S_R.lb = Y(1);
%Compute its upper bound
S_R.ub = Y(2);
