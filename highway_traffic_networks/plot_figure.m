...
%Load file
filename = num2str('database_table_1_globalsearch_jacobian.mat');
load(filename);

%Convert to matrix
tab_mat = table2cell(Tab_data(:,:));
tab_mat_gl_jac = cell2mat(tab_mat);
time_gl_jac = tab_mat_gl_jac(:,3);
Lip_gl_jac = tab_mat_gl_jac(:,2);
...
p3 = plot(N_pro,time_gl_jac,'MarkerFaceColor',[1.00 0.41 0.16],...
    'MarkerEdgeColor',[1.00 0.41 0.16],...
    'Marker','o',...
    'LineWidth',1.75,...
    'Color',[1.00 0.41 0.16]);
p4 = plot(N_pro,time_lds_pro_sobol,'MarkerFaceColor',[1 0 0],...
    'MarkerEdgeColor',[1 0 0],...
    'Marker','v',...
    'LineWidth',1.75,...
    'Color',[1 0 0]);
p5 = plot(N_pro,time_lds_pro_halton,'MarkerFaceColor',[0.600000023841858 0.200000002980232 0],...
...
hp(3) = plot(N_pro,time_gl_jac,'MarkerFaceColor',[1.00 0.41 0.16],...
    'MarkerEdgeColor',[1.00 0.41 0.16],...
    'Marker','o','LineWidth',1.5,'Color','none');
hp(4) = plot(N_pro,time_lds_pro_sobol,'MarkerFaceColor',[1 0 0],...
    'MarkerEdgeColor',[1 0 0],...
    'Marker','v','LineWidth',1.5,'Color','none');
hp(5) = plot(N_pro,time_lds_pro_halton,'MarkerFaceColor',[0.600000023841858 0.200000002980232 0],...
    'MarkerEdgeColor',[0.600000023841858 0.200000002980232 0],...
...
ylim([min([min(time_lds_pro_halton) min(time_lds_pro_sobol)]) 50+max([max(time_pro) max(time_gl_pro) max(time_gl_jac)])]);
yticks([0 10^0 10^1 10^2 10^3 10^4])
% ylim([0 10]);
leg1 = legend(hp,'IA','GS','GS$^{\dagger}$','Sobol','Halton');
